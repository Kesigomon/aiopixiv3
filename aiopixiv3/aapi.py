...
class AppPixivAPI(BasePixivAPI):
    ...
    async def no_auth_requests_call(self, method, url, headers={}, params=None, data=None, req_auth=True):
    ...
    async def user_bookmarks_illust(self, user_id, restrict='public', filter='for_ios', max_bookmark_id=None, tag=None, req_auth=True):
    ...
    # 相关作品列表
    async def illust_related(self, illust_id, filter='for_ios', seed_illust_ids=None, req_auth=True):
